...
#define TEAMWORK_MAX_PLAYER_MOVES 10
#define TEAMWORK_MAX_COMPUTER_MOVES 10
#define TEAMWORK_CAMP_RED 1
#define TEAMWORK_CAMP_BLACK 2
...
bool can_capture(const GameState *state, int from_row, int from_col, int to_row, int to_col);
